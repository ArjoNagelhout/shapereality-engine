...
v2f vertex main_vertex(device const VertexData* vertexData [[buffer(0)]],
...
half4 fragment main_fragment(v2f in [[stage_in]], texture2d <half, access::sample> tex [[texture(0)]])
{
