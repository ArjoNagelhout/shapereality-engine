...
namespace asset
{
    ...
    {
        std::filesystem::path inputFilePath; // path relative to a source directory, including file extension
        std::filesystem::path artifactPath{}; // path relative to the output file, including file extension
